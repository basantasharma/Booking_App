        ...
        <div class="flex">
            <div class="w-56 bg-gray-100 h-screen shadow-md">
                ...
                <div class="mt-12">
                    ...
                    <a href="" class="block text-xl pl-4 py-2 border-b-2 border-red-300 hover:bg-blue-600 hover:text-white">Notices</a>
                    ...
                    <!-- <a href="" class="block text-xl pl-4 py-2 border-b-2 border-red-300 hover:bg-blue-600 hover:text-white">News</a> -->
                    <a href="" class="block text-xl pl-4 py-2 border-b-2 border-red-300 hover:bg-blue-500 hover:text-white">News</a>

                    <form action="" method="POST" class="block text-xl pl-4 py-2 border-b-2 border-red-300 hover:bg-blue-600 hover:text-white">
                        @csrf
