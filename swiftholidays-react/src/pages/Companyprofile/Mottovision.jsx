...
const Mottovision = () => {
  return (
    <div>
      ...
      >
        <h1 className="text-center text-4xl p-20 font-semibold">Motto and Vision</h1>
      </div>
      <div>
        <h1 className="font-medium text-3xl text-center p-10">Mottovision</h1>
